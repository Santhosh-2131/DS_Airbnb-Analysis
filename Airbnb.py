...
with col1:
        image1 = Image.open("C:/Users/santh/source/repos/Capstone Projects/Airbnb/airbnb_logo.jpg")
        st.image(image1, width=300)
        
with col2:
    col2.subheader("NAME : Santhosh Kumar")
    col2.subheader("EMAIL: santhosh.shiawase@gmail.com")
    col2.subheader("BATCH : DW69DW70")